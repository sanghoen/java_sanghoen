...
-- 테이블명만 입력 하는 경우 : 속성 순서에 맞춰서 값들을 넣어줘야 한다
...
-- 학번이 2020316002인 컴퓨터공학과 임꺽정 학생을 추가하는 쿼리
insert into student(major, name, num) values('컴퓨터공학과','임꺽정','2023160002');
-- 과목 코드가 MSC001이고, 과목명이 대학수학기초인 과목을 추가하는 쿼리
...
-- 과목코드가 MSC002이고, 과목명이 영어1, 학점이 2학점, 일주일에 3시간 수업을 하는 과목을 추가하는 쿼리
insert into subject values('MSC002', '영어1', 2, 3);

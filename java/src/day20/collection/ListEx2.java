...
public class ListEx2 {
	...
	public static void main(String[] args) {
		...
		list.add(new Student(1,1,1,"Ga"));
		list.add(new Student(1,1,1,"Na"));
		list.add(new Student(1,1,1,"La"));
		list.add(new Student(1,1,1,"Ma"));
		System.out.println(list);
		/* remove메서드는 Objects 클래스의 equals를 호출(Object.equals(A,B))해서 true인 경우만 삭제

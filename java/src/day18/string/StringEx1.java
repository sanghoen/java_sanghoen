...
public class StringEx1 {
	...
	public static void main(String[] args) {
		/* 문자열 관련 메서드 */
		//indexOf : 기준 문자열에서 검색 문자/문자열을 왼쪽부터 검색해서 처음으로 만나는 위치를 반환함.
		//lastIndexOf : 기준 문자열에서 검색 문자/문자열을 오른쪽부터 검색해서 처음으로 만나는 위치를 반환함.
		...
		//contains : 기준 문자열에서 검색 문자/문자열이 있는지 없는지를 알려준다.
		...
		//trim 시작문자(a) 전 공백, 마지막문자(f) 후 공백을 제거, 사이에 있는 공백을 제거 못함
		String str4 = "\n\t\tabc\t\tdef\t\n";
